...
<head>
    <meta charset="UTF-8">
    <title>উদ্যোক্তা রেজিস্ট্রেশন</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 min-h-screen py-10 px-4">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-center text-green-700">উদ্যোক্তা রেজিস্ট্রেশন ফর্ম</h1>

        <form action="submit_registration.php" method="POST" enctype="multipart/form-data" class="space-y-6">
