...
<head>
    ...
    <title>Select Division - Clothing Entrepreneurs</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 min-h-screen flex flex-col items-center p-6">

    <h1 class="text-3xl font-bold mb-8">আপনার বিভাগ নির্বাচন করুন (পোশাক)</h1>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl">

        <!-- Rajshahi -->
        <a href="filtered_profiles.php?division=Rajshahi&type=clothing"
        ...
        <!-- Dhaka -->
        <a href="filtered_profiles.php?division=Dhaka&type=clothing"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Sylhet -->
        <a href="filtered_profiles.php?division=Sylhet&type=clothing"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Khulna -->
        <a href="filtered_profiles.php?division=Khulna&type=clothing"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Barisal -->
        <a href="filtered_profiles.php?division=Barisal&type=clothing"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Chittagong -->
        <a href="filtered_profiles.php?division=Chittagong&type=clothing"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
