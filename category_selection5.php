...
<head>
    ...
    <title>Select Division - Gymnasium Entrepreneurs</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 min-h-screen flex flex-col items-center p-6">

    <h1 class="text-3xl font-bold mb-8">আপনার বিভাগ নির্বাচন করুন (জিমনেসিয়াম)</h1>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl">

        <!-- Rajshahi -->
        <a href="filtered_profiles.php?division=Rajshahi&type=gymnasium"
        ...
        <!-- Dhaka -->
        <a href="filtered_profiles.php?division=Dhaka&type=gymnasium"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Sylhet -->
        <a href="filtered_profiles.php?division=Sylhet&type=gymnasium"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Khulna -->
        <a href="filtered_profiles.php?division=Khulna&type=gymnasium"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Barisal -->
        <a href="filtered_profiles.php?division=Barisal&type=gymnasium"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Chittagong -->
        <a href="filtered_profiles.php?division=Chittagong&type=gymnasium"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
