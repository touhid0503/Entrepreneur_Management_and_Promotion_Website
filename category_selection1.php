...
<head>
  ...
  <title>Select Division - Mason Entrepreneurs</title>
  <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 min-h-screen flex flex-col items-center p-6">

  <h1 class="text-3xl font-bold mb-8">আপনার বিভাগ নির্বাচন করুন (ম্যাসন)</h1>

  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl">

    <!-- Rajshahi -->
    <a href="filtered_profiles.php?division=Rajshahi&type=mason"
    ...
    <!-- Dhaka -->
    <a href="filtered_profiles.php?division=Dhaka&type=mason"
      class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
    ...
    <!-- Sylhet -->
    <a href="filtered_profiles.php?division=Sylhet&type=mason"
      class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
    ...
    <!-- Khulna -->
    <a href="filtered_profiles.php?division=Khulna&type=mason"
      class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
    ...
    <!-- Barisal -->
    <a href="filtered_profiles.php?division=Barisal&type=mason"
      class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
    ...
    <!-- Chittagong -->
    <a href="filtered_profiles.php?division=Chittagong&type=mason"
      class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
