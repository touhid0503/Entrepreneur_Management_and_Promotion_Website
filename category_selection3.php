...
<head>
    ...
    <title>Select Division - Event Management Entrepreneurs</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-100 min-h-screen flex flex-col items-center p-6">

    <h1 class="text-3xl font-bold mb-8">আপনার বিভাগ নির্বাচন করুন (ইভেন্ট ম্যানেজমেন্ট)</h1>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl">

        <!-- Rajshahi -->
        <a href="filtered_profiles.php?division=Rajshahi&type=eventmanagement"
        ...
        <!-- Dhaka -->
        <a href="filtered_profiles.php?division=Dhaka&type=eventmanagement"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Sylhet -->
        <a href="filtered_profiles.php?division=Sylhet&type=eventmanagement"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Khulna -->
        <a href="filtered_profiles.php?division=Khulna&type=eventmanagement"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Barisal -->
        <a href="filtered_profiles.php?division=Barisal&type=eventmanagement"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
        ...
        <!-- Chittagong -->
        <a href="filtered_profiles.php?division=Chittagong&type=eventmanagement"
            class="relative w-full h-64 bg-cover bg-center rounded-xl shadow-lg overflow-hidden group"
