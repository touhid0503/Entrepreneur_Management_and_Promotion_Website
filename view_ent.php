...
$sql = "SELECT * FROM entrepreneur_main";
...
<head>
    <meta charset="utf-8">
    <title>Entrepreneur Main - Admin</title>
                ...
                <table>
                    ...
                    <?php while ($info = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td><a href="delete.php?entmain_id=<?= $info['id'] ?>" class="btn btn-danger"
